...
<table cellpadding="0" cellspacing="1" class="table_form">
  ...
  <tr>
    ...
    <td><input id="device_identifier" name="device_identifier" style="width:300px"/> <a class="buttonlink" value="device_identifier" >条码扫描</a></td>
  </tr>
  <tr>
    <td width="151">隶属组织:</td>
    <td><input id="belongto" name="belongto" style="width:500px" value="belongto"/></td>
  </tr>
  <tr>
                  ...
                  <tr>
                    <td style="width:200px;">
                            <table cellpadding="0" cellspacing="0">
                                      ...
                                      <tr>
                                        <td>经度</td>
                                        <td><input type="text" name="longitude" id="longitude"class="easyui-numberbox" value="100" data-options="min:0,precision:2"></input></td>
                                      </tr>
                                      <tr>
                                        <td>纬度</td>
                                        <td><input type="text" name="latitude" id="latitude" class="easyui-numberbox" value="100" data-options="min:0,precision:2"></input></td>
                                      </tr>
                                      <tr>
                                        <td>海拔高度</td>
		   ...
		   function GoNext()
			{
			   ...
			   // alert(jStr);
				window.location.href="http://localhost:8080/IoT_Harbor/information.html?"+jStr;
			}
...
<table cellpadding="0" cellspacing="0" style="width:100%">
          ...
          <tr>
            <td width="100%" style="padding:10px;text-align:center;">
                <a class="buttonlink" href="#" onclick="GoPre();return false;" >上一步</a>
