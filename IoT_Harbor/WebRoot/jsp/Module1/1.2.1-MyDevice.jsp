...
<table cellpadding="0" cellspacing="1" class="table_form">
          ...
          <tr>
            ...
            <td width="443" style="text-align:left;">
                <a class="buttonlink" onclick="searchgener();return false;">筛选</a>
            </td>
          </tr>
         <!--  <tr>
            <td>设备状态：</td>
            <td><input name="deviceStatus" style="width:920px"/></td>
            <td width="443" style="text-align:left;">
            </td>
          </tr>
          <tr>
            <td>生命周期：</td>
            <td><input name="deviceAvailableTime" style="width:920px"/></td>
            <td width="443" style="text-align:left;">
                <a class="buttonlink" onclick="searchgener();return false;">筛选</a>
            </td>
          </tr> -->
...
<table cellpadding="0" cellspacing="1" class="table_form">
          ...
          <tr>
						...
						function Eventformatter(value,row,index)
			{
				...
				return "<a href='' class='buttonlink' onclick='Event_Update(\""+pid+"\");return false;' target='_blank'>修改</a><a href='#' class='buttonlink' onclick='Event_Delete(\""+pid+"\");return false;' target='_blank'>删除</a><a href='B_R_1_1_2_1.html' class='buttonlink'onclick='Event_Active(\""+pid+"\");return false;' target='_blank'>激活</a><a href='B_R_1_1_2_1.html' class='buttonlink' onclick='Event_Unactive(\""+pid+"\");return false;' target='_blank'>冻结</a><a href='B_R_1_1_2_1.html' class='buttonlink'onclick='Event_Query(\""+pid+"\");return false;' target='_blank'>查看</a>";
				//return "";
			}
			///*   */
			</script>
			...
			function Event_Update(ID)
			{
				...
				window.location.href="/IoT_Harbor/mydevice_update.html?ID="+ID;
				/* $.ajax({type:"GET",
				   	url:"/IoT_Harbor/update.html",
					data:"ID="+ID,
			...
			function Event_Delete(ID)
			{
				...
				$.ajax({type:"GET",
				   	url:"/IoT_Harbor/mydevice_delete.html",
					data:"ID="+ID,
					success:function(json)
				   	{
							if(json=="success")
			...
			function Event_Query(ID)
			{
				...
				window.location.href="/IoT_Harbor/mydevice_query.html?ID="+ID;
            ...
            <table id="localdeviceView" class="easyui-datagrid" style="height:300px;"
                        data-options="rownumbers:true,singleSelect:true,url:'/IoT_Harbor/mydevice.html',method:'post',onClickRow:ClickIng">
			        <thead>
