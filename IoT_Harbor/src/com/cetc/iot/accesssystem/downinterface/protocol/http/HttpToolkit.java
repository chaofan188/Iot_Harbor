...
public class HttpToolkit {
	...
	private static Logger logger = Logger.getLogger(HttpToolkit.class.getName());
	...
	public static String doGet(String url, String queryString, String charset,
		...
		try {
			...
			logger.info("执行HTTP Get请求时，编码查询字符串“"+ queryString+"”发生异常！ ");
		} catch (IOException e) {
			logger.info("执行HTTP Get请求"+url+"时，发生异常！");
		} finally {
